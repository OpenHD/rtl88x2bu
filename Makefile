...
#	rm -f .symvers.$(MODULE_NAME)
	    @echo '#define DRIVERVERSION "v1.19.3_ohd_$(shell git rev-parse --short HEAD)"' > $(VERSION_HEADER)
...
clean:
	@echo '#define DRIVERVERSION "v1.19.3_ohd_THIS_IS_DIRTY"' > $(VERSION_HEADER)
