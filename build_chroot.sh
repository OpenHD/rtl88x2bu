...
ls -a
fpm -a amd64 -s dir -t deb -n rtl8852bu-x86 -v 2.5-evo-$(date '+%m%d%H%M') -C package -p rtl8852bu-x86.deb --before-install before-install.sh --after-install after-install.sh
